...
```{r logo,echo=FALSE,out.height="100px",out.width="100px"}
knitr::include_graphics("ordbetareg_transparent_v2.png")
```
...
To learn more about beta regression modeling and where this package fits in, you can read [my blog post on the topic](https://www.robertkubinec.com/post/limited_dvs/). To learn how to use the package, see the introduction vignette by using the `vignette("package_introduction", package="ordbetareg")` command at the R console or viewing the [vignette on CRAN](https://cran.r-project.org/web/packages/ordbetareg/vignettes/package_introduction.html).
