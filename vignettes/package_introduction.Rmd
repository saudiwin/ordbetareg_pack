...
In this vignette I use an empirical application from data from a Pew Forum survey built into the package to show how the package works. This data contains a bounded response from a question about respondents' views towards college professors:
