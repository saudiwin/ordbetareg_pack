...
If we wanted to rescale the coefficients to be back on the original 0 - 100 thermometer scale, we can repeat the exercise by passing a simple function to the underlying `brms` function to multiply the estimates by 100:

```{r marg_effect_rescale,warn=FALSE}
library(marginaleffects)
