...
**Please note that this is not the only implementation of ordered beta regression. For more info on alternatives, including other statistical software packages, see the package website.**

For more information, I refer you to my [paper on the model](https://www.cambridge.org/core/journals/political-analysis/article/ordered-beta-regression-a-parsimonious-wellfitting-model-for-continuous-data-with-lower-and-upper-bounds/89F4141DA16D4FC217809B5EB45EEE83) for more details (also there is an ungated version available [here](https://osf.io/preprints/socarxiv/2sx6y/)).
